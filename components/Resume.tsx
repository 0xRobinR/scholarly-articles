...
const eduDetails = [
  { name: "bachelor of computer science", place: "new york university", date: "2010 - 2014" },
  { name: "master of computer science", place: "new york university", date: "2014 - 2016" },
  { name: "PHD of computer science", place: "new york university", date: "2016 - 2018" },
];

const exDetails = [
  { name: "junior frontend developer", place: "facebook", date: "2018 - 2019" },
  { name: "senior frontend developer", place: "google", date: "2019 - 2020" },
  { name: "lead frontend developer", place: "uber", date: "2020 - 2022" },
];
